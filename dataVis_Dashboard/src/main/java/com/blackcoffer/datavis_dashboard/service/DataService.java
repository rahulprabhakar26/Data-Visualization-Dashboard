...
//	List<Data> getDataBySector(String sector);
	 ...
	 List<Data> getDataByFilters(Integer endyear, String topic, String sector, String region, String pestle, String source, String swot, String country, String city);
